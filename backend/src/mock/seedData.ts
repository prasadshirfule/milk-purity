...
export const SEED_TESTS: IMilkTest[] = [
  ...
  },
  {
    ...
    prediction: 'ADULTERATED_WATER_NEUTRALIZER',
    confidence: 0.92,
    warnings: [
      'Conductivity high (7.2 mS/cm) indicating added salts or neutralizers',
      'Density low (1.021 g/mL) indicating severe water dilution',
      'Fat content sub-standard (2.8%)'
    ],
    result: 'REJECTED',
    ratePerLiter: 0,
    totalAmount: 0,
  ...
  },
  {
    ...
    qualityScore: 78.2,
    classification: 'GOOD',
    prediction: 'ACCEPTABLE_BORDERLINE',
    confidence: 0.88,
  ...
  },
  {
    ...
    qualityScore: 50.5,
    classification: 'REJECT',
    prediction: 'ADULTERATED_WATER_SALT',
    confidence: 0.94,
    warnings: [
